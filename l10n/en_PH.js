OC.L10N.register(
    ...
    "- Text chatting can now be done in a federated way with other Talk servers" : "- Text chatting can now be done in a federated way with other Konvo servers",
    ...
    "- Calls can now be done in a federated way with other Talk servers (requires the High-performance backend)" : "- Calls can now be done in a federated way with other Konvo servers (requires the High-performance backend)",
    ...
    "Talk conversations" : "Konvo threads",
    "Talk to %s" : "Konvo with %s",
    ...
    "Contact via Talk" : "Contact via Konvo",
    "Open Talk" : "Open Konvo",
    ...
    "Close Talk sidebar" : "Close Konvo sidebar",
    "Open Talk sidebar" : "Open Konvo sidebar",
    ...
    "Users that cannot use Talk anymore will still be listed as participants in their previous conversations and also their chat messages will be kept." : "Users that cannot use Konvo anymore will still be listed as participants in their previous conversations and also their chat messages will be kept.",
    "Limit using Talk" : "Limit using Konvo",
    ...
    "Disabled" : "Disabled",
    "Beta" : "Beta",
    "Enable Federation in Talk app" : "Enable Federation in Konvo",
    ...
    "Warning: Running version: {version}; Server does not support all features of this Talk version, missing features: {features}" : "Warning: Running version: {version}; Server does not support all features of this Konvo version, missing features: {features}",
    "Could not get version" : "Could not get version",
    "Error: Running version: {version}; Server needs to be updated to be compatible with this version of Talk" : "Error: Running version: {version}; Server needs to be updated to be compatible with this version of Konvo",
    ...
    "It is highly recommended to set up a distributed cache when using Nextcloud Talk together with a High Performance Back-end." : "It is highly recommended to set up a distributed cache when using Konvo together with a High Performance Back-end.",
    ...
    "Talk conversation" : "Konvo thread",
    ...
    "Talk recording from {time} ({conversation})" : "Konvo recording from {time} ({conversation})",
    ...
    "Speed up your Talk experience with these quick shortcuts." : "Speed up your Konvo experience with these quick shortcuts.",
    ...
    "End call" : "End call",
    "Nextcloud Talk was updated, you need to reload the page before you can start or join a call." : "Konvo was updated, you need to reload the page before you can start or join a call.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by Nextcloud Talk so this session was closed." : "You joined the conversation in another window or device. This is currently not supported by Konvo so this session was closed.",
    ...
    "Nextcloud Talk was updated, please reload the page" : "Konvo was updated, please reload the page",
    "(edited)" : "(edited)",
    ...
    "Nextcloud Talk Federation was updated, please reload the page" : "Konvo Federation was updated, please reload the page",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by Nextcloud Talk. What do you want to do?" : "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by Nextcloud Konvo. What do you want to do?",
    "Join here" : "Join here",
    ...
    "The browser you're using is not fully supported by Nextcloud Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "The browser you're using is not fully supported by Konvo. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari.",
    ...
    "The configured signaling server needs to be updated to be compatible with this version of Talk. Please contact your administration." : "The configured signaling server needs to be updated to be compatible with this version of Konvo. Please contact your administration.",
    ...
    "%s Talk on your mobile devices" : "%s Konvo on your mobile devices",
    ...
    "Commands are a new beta feature in Nextcloud Talk. They allow you to run scripts on your Nextcloud server. You can define them with our command line interface. An example of a calculator script can be found in our {linkstart}documentation{linkend}." : "Commands are a new beta feature in Konvo. They allow you to run scripts on your Nextcloud server. You can define them with our command line interface. An example of a calculator script can be found in our {linkstart}documentation{linkend}.",
    ...
    "- Unsent message drafts are now saved in your browser " : "- Unsent message drafts are now saved in your browser ",
    "- *Preview:* Text chatting can now be done in a federated way with other Talk servers" : "- *Preview:* Text chatting can now be done in a federated way with other Konvo servers"
},
